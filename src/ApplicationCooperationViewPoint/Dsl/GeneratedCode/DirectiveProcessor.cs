...
namespace Bb.ApplicationCooperationViewPoint
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides ApplicationCooperationViewPoint files
	/// The implementation is done in ApplicationCooperationViewPointDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class ApplicationCooperationViewPointDirectiveProcessor : ApplicationCooperationViewPointDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ApplicationCooperationViewPointDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides ApplicationCooperationViewPoint files
	/// </summary>
	public class ApplicationCooperationViewPointDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string ApplicationCooperationViewPointDirectiveProcessorName = "ApplicationCooperationViewPointDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "CooperationModel";
		...
		/// </summary>
		private const string supportedDirectiveName = "ApplicationCooperationViewPoint";
		...
		/// Constructor
		/// </summary>
		public ApplicationCooperationViewPointDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return ApplicationCooperationViewPointDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Bb.ApplicationCooperationViewPoint.CooperationModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Bb.ApplicationCooperationViewPoint.CooperationModel));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "CooperationModel" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("ApplicationCooperationViewPointDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("Bb.ApplicationCooperationViewPoint");
