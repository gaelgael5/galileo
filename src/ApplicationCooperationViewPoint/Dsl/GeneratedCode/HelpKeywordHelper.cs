...
namespace Bb.ApplicationCooperationViewPoint
{
	...
	/// </remarks>
	public partial class ApplicationCooperationViewPointHelpKeywordHelper : ApplicationCooperationViewPointHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointHelpKeywordHelper.
		/// </summary>
		protected ApplicationCooperationViewPointHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ApplicationCooperationViewPointHelpKeywordHelper.
		/// </summary>
		public static ApplicationCooperationViewPointHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ApplicationCooperationViewPointHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointHelpKeywordHelperBase.
		/// </summary>
		protected ApplicationCooperationViewPointHelpKeywordHelperBase()
			: base() { }
