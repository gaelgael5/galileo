...
namespace Bb.ApplicationCooperationViewPoint
{
	...
	/// </remarks>
	public partial class ApplicationCooperationViewPointToolboxHelper : ApplicationCooperationViewPointToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointToolboxHelper.
		/// </summary>
		public ApplicationCooperationViewPointToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ApplicationCooperationViewPointToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify ApplicationCooperationViewPoint toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "ApplicationCooperationViewPoint.0.1";
		...
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointToolboxHelperBase.
		/// </summary>
		protected ApplicationCooperationViewPointToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointDomainModel.SingletonResourceManager.GetString("Cooperation ViewpointToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointDomainModel));
