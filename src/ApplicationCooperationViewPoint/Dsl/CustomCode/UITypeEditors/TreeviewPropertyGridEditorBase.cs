...
{
    public abstract class TreeviewPropertyGridEditorBase : UITypeEditor
    {
        ...
        protected abstract string GetValue(TreeNode selectedItem);
        ...
        protected abstract List<TreeNode> List();
