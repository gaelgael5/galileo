...
namespace Bb.ApplicationCooperationViewPoint
{
	...
	/// </summary>
	internal partial class ApplicationCooperationViewPointDocView : ApplicationCooperationViewPointDocViewBase
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointDocView.
		/// </summary>
		public ApplicationCooperationViewPointDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ApplicationCooperationViewPointDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointDocView.
		/// </summary>
		protected ApplicationCooperationViewPointDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ApplicationCooperationViewPointDocDataBase docData = this.DocData as ApplicationCooperationViewPointDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ApplicationCooperationViewPointDocViewBase should be an ApplicationCooperationViewPointDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ApplicationCooperationViewPointDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Bb.ApplicationCooperationViewPoint.ApplicationCooperationViewPointHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
