...
namespace Bb.ApplicationCooperationViewPoint
{
	...
	/// </summary>
	internal partial class ApplicationCooperationViewPointCommandSet : ApplicationCooperationViewPointCommandSetBase
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointCommandSet.
		/// </summary>
		public ApplicationCooperationViewPointCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ApplicationCooperationViewPointCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointCommandSetBase.
		/// </summary>
		protected ApplicationCooperationViewPointCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewApplicationCooperationViewPointExplorerCommand,
				typeof(ApplicationCooperationViewPointEditorFactory).GUID);
		...
		{
			ApplicationCooperationViewPointExplorerToolWindow explorer = this.ApplicationCooperationViewPointExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ApplicationCooperationViewPointDocData CurrentApplicationCooperationViewPointDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ApplicationCooperationViewPointDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ApplicationCooperationViewPointDocView CurrentApplicationCooperationViewPointDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ApplicationCooperationViewPointDocView;
			}
		}
		...
		/// </summary>
		protected ApplicationCooperationViewPointExplorerToolWindow ApplicationCooperationViewPointExplorerToolWindow
		{
			get
			{
				ApplicationCooperationViewPointExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ApplicationCooperationViewPointExplorerToolWindow), true) as ApplicationCooperationViewPointExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ApplicationCooperationViewPointExplorerToolWindow explorerWindow = this.ApplicationCooperationViewPointExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ApplicationCooperationViewPointClipboardCommandSet : ApplicationCooperationViewPointClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointClipboardCommandSet.
		/// </summary>
		public ApplicationCooperationViewPointClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ApplicationCooperationViewPointClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ApplicationCooperationViewPointClipboardCommandSetBase.
		/// </summary>
		protected ApplicationCooperationViewPointClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
